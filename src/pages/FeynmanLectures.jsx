  ...
  return (
    <div className="book-page">
      <div className="book-container">
        ...
        <h2 className='h2' style={{ textAlign: 'center' }}>by Richard P. Feynman</h2>
        <div className="book-content narrow-text scrollable">
          <div id="Ch1-S1" className="section">
            <h3 className="section-title">
              <span className="tag">1–1</span> Introduction</h3>
            ...
            <div id="Ch1-S1-p6" className="para">
              <p className="p">We said that the laws of nature are approximate: that we first find the
                ...
                things, how <em className="emph">can</em> the results of an experiment be wrong? Only by
                ...
                <em className="emph">true</em> law is: if an object moves with a speed of less than one
            ...
            <div id="Ch1-S1-p7" className="para">
              <p className="p">Finally, and most interesting, <em className="emph">philosophically we are completely
                wrong</em> with the approximate law. Our entire picture of the world has to
            ...
            <div id="Ch1-S1-p8" className="para">
              <p className="p">Now, what should we teach first? Should we teach the <em className="emph">correct</em> but
            ...
            <div id="Ch1-S1-p9" className="para">
              <p className="p">Let us now proceed with our outline, or general map, of our
                ...
                So, what <em className="emph">is</em> our overall picture of the world?</p>
            </div>
          </div>
        </div>
      </div>
